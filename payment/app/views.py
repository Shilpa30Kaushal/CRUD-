...
def item_payment(request):
    if request.method=="POST":
        ...
        print(amount)
        client = razorpay.Client(auth=("rzp_test_eWtWhTnmVlogfO" , "4Iv5IDJ8vN1pCNxZQ0MQSb7d" ))
        print(client)
...
def payment_status(request):
    ...
    if request.method=='POST':
        ...
        # client instance
        client = razorpay.Client(auth=("rzp_test_AnBDZ8kQC5dfBk" , "9wHnTRW7MVzwFpEcDSHgc8My" ))
